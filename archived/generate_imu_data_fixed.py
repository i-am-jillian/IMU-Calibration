"""
generate_imu_data_fixed.py
==========================
Generates synthetic IMU data for Allan-deviation validation.

Run:
    python generate_imu_data_fixed.py --duration 7200 --fs 100 --out data/test_imu.csv
"""
...
from Imusim_fixed import StaticTrajectory, RealisticIMU
...
imu = RealisticIMU(
    ...
    accel_bias_instability=2e-4,
    gyro_bias_instability=8e-5,
