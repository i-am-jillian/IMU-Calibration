...
====================
Generates synthetic IMU data for testing allan_analysis.py.

Creates a sample CSV with known stochastic terms

run:
-----
    python generateImuData.py --duration 3600 --fs 100 --out data/test_imu.csv
"""
...
from archived.Imusim import StaticTrajectory, RealisticIMU
...
imu = RealisticIMU(
    ...
    gyro_noise_std=3e-3,
    accel_bias_rw_std=3e-4,
    gyro_bias_rw_std=1e-4,
...
print("\nInjected terms used only for validation:")
